...
public class Menu_Left extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        menuMessage.setIconSelected(new javax.swing.ImageIcon(getClass().getResource("/com/project/icon/message_selected.png"))); // NOI18N
        menuMessage.setIconSimple(new javax.swing.ImageIcon(getClass().getResource("/com/project/icon/message.png"))); // NOI18N
        ...
        menuGroup.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/project/icon/group.png"))); // NOI18N
        menuGroup.setIconSelected(new javax.swing.ImageIcon(getClass().getResource("/com/project/icon/group_selected.png"))); // NOI18N
        menuGroup.setIconSimple(new javax.swing.ImageIcon(getClass().getResource("/com/project/icon/group.png"))); // NOI18N
        ...
        menuBox.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/project/icon/box.png"))); // NOI18N
        menuBox.setIconSelected(new javax.swing.ImageIcon(getClass().getResource("/com/project/icon/box_selected.png"))); // NOI18N
        menuBox.setIconSimple(new javax.swing.ImageIcon(getClass().getResource("/com/project/icon/box.png"))); // NOI18N
