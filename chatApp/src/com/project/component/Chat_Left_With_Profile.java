...
public class Chat_Left_With_Profile extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        IaImage = new com.project.swing.ImageAvatar();
        txt = new com.project.component.Chat_Item();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/project/icon/testing/dog.jpg"))); // NOI18N
    ...
    private com.project.swing.ImageAvatar IaImage;
