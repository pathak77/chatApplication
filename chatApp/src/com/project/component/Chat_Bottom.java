...
public class Chat_Bottom extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/project/icon/more_disable.png")));
        cmdMore.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (panelMore.isVisible()) {
                    ...
                    cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/project/icon/more.png")));
