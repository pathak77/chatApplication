...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/project/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/project/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.project.swing.JIMSendTextPane();
    ...
    private com.project.swing.JIMSendTextPane txt;
